...
<head>
  ...
  <title>Happy 20th Birthday, Lovey!</title>
  <link href="https://fonts.googleapis.com/css2?family=Pacifico&family=Quicksand:wght@400;600&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&family=Raleway:wght@400;600&display=swap" rel="stylesheet">
  <style>
    body {
      margin: 0;
      padding: 0;
      font-family: 'Raleway', sans-serif; /* Changed to Raleway for a more aesthetic look */
    ...
    h1 {
      color: #d63384;
      font-family: 'Pacifico', cursive; /* Keep Pacifico for the heading */
      font-size: 2.5rem;
